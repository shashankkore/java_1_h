package com.cvs.crm.cukes.customerSearch.hooks;
...
@Slf4j
public class customerSearchHook {
    ...
    List<String> testData_XC = Arrays.asList("XC_99901", "XC_99902","XC_99903");

    @Before(value = "@CustomerSearch")
    public void setup() throws ParseException, InterruptedException, SQLException {
        if ("stub".equalsIgnoreCase(serviceConfig.getActiveProfile())) {
            ...
            while (itr.hasNext()){
                ...
                System.out.println("CHECK >>  " + testDataUtil.extractTestData(testDataFile, test_XC));
