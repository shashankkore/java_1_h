package com.cvs.crm.cukes.getCustDealsByLocalTime.hooks;
...
@Slf4j
public class DealsRewardsByLocalTimeHook {
    ...
    @Before(value = "@GetCustDealsRewardsByLocalTime")
    ...
    @After(value = "@GetCustDealsRewardsByLocalTime")
