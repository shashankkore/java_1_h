package com.cvs.crm.cukes.GetCustomerProfile.glue;
...
import com.cvs.crm.service.GetCustomerProfileService;
...
@Slf4j
public class GetCustomerProfileStepDefinitions extends SpringIntegrationTests implements En {

    @Autowired
    GetCustomerProfileService getCustomerProfileService;
    @Autowired
    ...
    public GetCustomerProfileStepDefinitions() {
        {
