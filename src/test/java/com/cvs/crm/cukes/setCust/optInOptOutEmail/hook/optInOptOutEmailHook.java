package com.cvs.crm.cukes.setCust.optInOptOutEmail.hook;
...
@Slf4j
public class optInOptOutEmailHook {
    ...
    @Before(value = "@SetCust_OptIn_OptOut_Email")
    ...
    @After(value = "@SetCust_OptIn_OptOut_Email")
