package com.cvs.crm.cukes.setCust.optInOptOutSMS.hook;
...
@Slf4j
public class optInOptOutSMSHook {
    ...
    @Before(value = "@SetCust_OptIn_OptOut_SMS")
    ...
    @After(value = "@SetCust_OptIn_OptOut_SMS")
