package com.cvs.crm.cukes.setCust.DOBCollection.hook;
...
@Slf4j
public class DOBCollectionHook {
    ...
    @Before(value = "@SetCust_DOB_Collection")
    ...
    @After(value = "@SetCust_DOB_Collection")
