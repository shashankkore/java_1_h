package com.cvs.crm.cukes.getCust.pushNotifications.hook;

import com.cvs.crm.config.ServiceConfig;
import com.cvs.crm.service.GetCustPushNotificationsService;
import com.cvs.crm.stubs.GetCustPushNotificationsStub;
...
public class pushNotificationHook {
    ...
    @Autowired
    GetCustPushNotificationsStub getCustPushNotificationsStub;
    @Autowired
    ...
    /**
     *  Setup Test Data for GetCust Push Notifications
     */
    @Before(value = "@GetCustPushNotifications")
    public void setup() throws ParseException, InterruptedException, SQLException {
        if ("stub".equalsIgnoreCase(serviceConfig.getActiveProfile())) {
            // Setup Stubs
            GetCustPushNotificationsStub.createGetCustPushNotificationsStubData();
        } else {
    ...
    @After(value = "@GetCustPushNotifications")
