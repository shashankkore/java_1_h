package com.cvs.crm.cukes.getCust.mfrCpnAvailPool.hook;
...
@Slf4j
public class mfrCpnAvailPoolHook {
    ...
    @Before(value = "@GetCust_MfrCpnAvailPool")
...
//
    ...
    @After(value = "@GetCust_MfrCpnAvailPool")
