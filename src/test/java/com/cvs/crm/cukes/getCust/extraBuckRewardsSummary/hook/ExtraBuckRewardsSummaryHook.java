package com.cvs.crm.cukes.getCust.extraBuckRewardsSummary.hook;
...
@Slf4j
public class ExtraBuckRewardsSummaryHook {
    ...
    @Before(value = "@GetCust_extraBuckRewardsSummary")
    ...
    @After(value = "@GetCust_extraBuckRewardsSummary")
