...
@Data
@Slf4j
public class CustomerReceiptPreferenceService {
	...
	public void extractXMLForDigitalReceipts(CustRecPrefRequest custRecPrefRequest) {
		Integer cardNum = custRecPrefRequest.getXtraCardNbr();
		Integer encodedXTraCardNbr = custRecPrefRequest.getEncodedXtraCardNbr();
		String msgSrcCd = "W";
