...
@Data
@Slf4j
public class SetCustCarepassEnrollmentService2 {
    ...
    private RequestSpecBuilder setCust_baseUri(SetCustRequest setCustRequest) {
        ...
        if (setCustRequest.getChannel().equalsIgnoreCase("M")) {
            ...
            srcLocCd = 2695;
            userId = "CVS.COM";
        } else if (setCustRequest.getChannel().equalsIgnoreCase(("R"))){
            msgSrcCd = "R";
            srcLocCd = 68585;
            userId = "STORE";
        } else if (setCustRequest.getChannel().equalsIgnoreCase(("IVR_M"))){
            msgSrcCd = "I";
            srcLocCd = 0;
            userId = "MOBILE_ENT";
        } else if (setCustRequest.getChannel().equalsIgnoreCase(("IVR_W"))){
            msgSrcCd = "I";
            srcLocCd = 0;
            userId = "CVS.COM";
        } else if (setCustRequest.getChannel().equalsIgnoreCase(("IVR"))){
            msgSrcCd = "I";
            srcLocCd = 0;
            userId = "IVR";
        } else
            throw new IllegalStateException("Invalid Channel passed: " + setCustRequest.getChannel());
    ...
    /***
     *     SetCust Actions - optInEmail, optOutEmail, optInMail, optOutMail,
     *     optInSMS, optOutSMS, optInDigitalReceipt, optOutDigitalReceipt,
     *     DOBcollection, DOBCollection_with_Phone_PrefSeqNbr, DOBCollection_with_Email_PrefSeqNbr,
     *     IVR_Update_PhoneNbr, IVR_Submit_Order,
    ...
    public Response setCust(SetCustRequest setCustRequest, String setCust_action) throws ParseException, InterruptedException {
        ...
        switch (setCust_action.toLowerCase()) {
            ...
            case "optoutmail":
                ...
                break;
            case "optinsms":
                getServiceBody = getServiceBody_OptInSMS(setCustRequest);
                break;
            case "optoutsms":
                getServiceBody = getServiceBody_OptOutSMS();
                break;
            ...
            case "optoutdigitalreceipt":
                ...
                break;
            case "dobcollection":
                getServiceBody = getServiceBody_DOBCollection(setCustRequest);
                break;
            case "dobcollection_with_phone_prefseqnbr":
                getServiceBody = getServiceBody_DOBCollection_with_Phone_PrefSeqNbr(setCustRequest);
                break;
            case "dobcollection_with_email_prefseqnbr":
                getServiceBody = getServiceBody_DOBCollection_with_Email_PrefSeqNbr(setCustRequest);
                break;
            case "ivr_phonenbr_update":
                getServiceBody = getServiceBody_IVR_PhoneNbrUpdate(setCustRequest);
                break;
            case "ivr_submit_order":
                getServiceBody = getServiceBody_IVR_SubmitOrder(setCustRequest);
                break;
            case "ccpa_data":
                getServiceBody = getServiceBody_CCPA_Data(setCustRequest);
                break;
            case "ccpa_data_exclude_optional_fields":
                getServiceBody = getServiceBody_CCPA_Data_Exclude_Optional(setCustRequest);
                break;
            ...
            case "carepass_unenroll_monthly":
                ...
                break;
            default:
                throw new IllegalStateException("Unexpected value: " + setCust_action);
        }
        System.out.println("getServiceBody :: \n" + getServiceBody);
...
//        serviceResponse.prettyPrint();
    ...
    private String getServiceBody_CarePass_Enroll_Monthly() {
        String json_body = "{\n" +
                "    \"xtraCare\": {\n" +
                "        \"carepass\": {\n" +
                "            \"tables\": [\n" +
    ...
    private String getServiceBody_CarePass_UnEnroll_Monthly(){
        String json_body = "{\n" +
                "    \"xtraCare\": {\n" +
                "        \"carepass\": {\n" +
                "            \"tables\": [\n" +
    ...
    private String getServiceBody_OptInSMS(SetCustRequest setCustRequest) {
        String json_body = "{\n" +
                "    \"xtraCare\": {\n" +
                "        \"prefs\": {\n" +
                "            \"sms\": {\n" +
                "                \"optCd\": \"Y\",\n" +
                "                \"lastUpdtById\": \"STR68624EMP0000111\"\n" +
                "            }\n" +
                "        }\n" +
                "    },\n" +
                "    \"tables\": [\n" +
                ...
                "                        \"phonePrefSeqNbr\": \"9\",\n" +
                "                        \"phoneTypeCd\": \"S\",\n" +
                "                        \"phoneAreaCdNbr\": \"" + setCustRequest.getPhoneAreaCdNbr() + "\",\n" +
                "                        \"phonePfxNbr\": \"" + setCustRequest.getPhonePfxNbr() + "\",\n" +
                "                        \"phoneSfxNbr\": \"" + setCustRequest.getPhoneSfxNbr() + "\",\n" +
                "                        \"lastUpdtSrcCd\": \"053\",\n" +
                "                        \"lastUpdtDt\": \"SYSDATE\",\n" +
                "                        \"lastUpdtById\": \"STR68624EMP0000111\"\n" +
                "                    },\n" +
    ...
    private String getServiceBody_OptOutSMS() {
        String json_body = "{\n" +
                "    \"xtraCare\": {\n" +
                "        \"prefs\": {\n" +
                "            \"sms\": {\n" +
    ...
    private String getServiceBody_DOBCollection(SetCustRequest setCustRequest) {
        String json_body = "{\n" +
                "    \"tables\": [\n" +
                "        {\n" +
                "            \"name\": \"CUSTOMER\",\n" +
                ...
                "                    \"action\": \"UPDATE\",\n" +
                "                    \"colData\": {\n" +
                "                        \"birthDt\": \"" + setCustRequest.getBirthDt() + "\",\n" +
                "                        \"lastUpdtSrcCd\": \"042\",\n" +
                "                        \"lastUpdtDt\": \"SYSDATE\",\n" +
                "                        \"lastUpdtById\": \"WEBWEB000000000\"\n" +
                "                    }\n" +
    ...
    private String getServiceBody_DOBCollection_with_Phone_PrefSeqNbr(SetCustRequest setCustRequest) {
        String json_body = "{\n" +
                "    \"tables\": [\n" +
                "        {\n" +
                "            \"name\": \"CUSTOMER\",\n" +
                ...
                "                        \"phoneAreaCdNbr\": \"" + setCustRequest.getPhoneAreaCdNbr() + "\",\n" +
                "                        \"phonePfxNbr\": \"" + setCustRequest.getPhonePfxNbr() + "\",\n" +
                "                        \"phonePrefSeqNbr\": \"" + setCustRequest.getPhonePrefSeqNbr() + "\",\n" +
                "                        \"phoneSfxNbr\": \"" + setCustRequest.getPhoneSfxNbr() + "\",\n" +
                "                        \"phoneTypeCd\": \"" + setCustRequest.getPhoneTypeCd() + "\",\n" +
                "                        \"lastUpdtById\": \"WEB4872000135718\"\n" +
                "                    },\n" +
                "                    \"criterias\": [\n" +
                "                        {\n" +
                "                            \"colName\": \"phoneTypeCd\",\n" +
                "                            \"operation\": \"=\",\n" +
                "                            \"value\": \"" + setCustRequest.getPhoneTypeCd() + "\"\n" +
                "                        }\n" +
                "                    ]\n" +
                "                }\n" +
                "            ]\n" +
    ...
    private String getServiceBody_DOBCollection_with_Email_PrefSeqNbr(SetCustRequest setCustRequest) {
        String json_body = "{\n" +
                "    \"tables\": [\n" +
                "        {\n" +
                "            \"name\": \"CUSTOMER\",\n" +
                ...
                "                    \"action\": \"update_insert\",\n" +
                "                    \"colData\": {\n" +
                "                        \"emailPrefSeqNbr\": \"" + setCustRequest.getEmailPrefSeqNbr() + "\",\n" +
                "                        \"emailAddrTypeCd\": \"" + setCustRequest.getEmailAddrTypeCd() + "\",\n" +
                "                        \"emailAddrTxt\": \"" + setCustRequest.getEmailAddrTxt() + "\",\n" +
                "                        \"emailStatusCd\": \"" + setCustRequest.getEmailStatusCd() + "\",\n" +
                "                        \"lastUpdtSrcCd\": \"001\",\n" +
                "                        \"lastUpdtById\": \"WEB537469764\",\n" +
                "                        \"lastUpdtDt\": \"SYSDATE\"\n" +
                "                    },\n" +
                "                    \"criterias\": [\n" +
                "                        {\n" +
                "                            \"colName\": \"emailPrefSeqNbr\",\n" +
                "                            \"operation\": \"=\",\n" +
                "                            \"value\": \"" + setCustRequest.getEmailPrefSeqNbr() + "\"\n" +
                "                        }\n" +
                "                    ]\n" +
                "                }\n" +
                "            ]\n" +
    ...
    private String getServiceBody_IVR_PhoneNbrUpdate(SetCustRequest setCustRequest) {
        String json_body = "{\n" +
                "    \"tables\": [\n" +
                "        {\n" +
                "            \"name\": \"customer_phone\",\n" +
                ...
                "                    \"criterias\": [\n" +
                "                        {\n" +
                "                            \"colName\": \"phonePrefSeqNbr\",\n" +
                "                            \"operation\": \"=\",\n" +
                "                            \"value\": \"" + setCustRequest.getPhonePrefSeqNbr() + "\"\n" +
                "                        }\n" +
                "                    ]\n" +
                "                }\n" +
                "            ]\n" +
    ...
    private String getServiceBody_IVR_SubmitOrder(SetCustRequest setCustRequest) {
        String json_body = "{\n" +
                "    \"tables\": [\n" +
                "        {\n" +
                "            \"name\": \"card_reorders\",\n" +
                ...
                "                    \"colData\": {\n" +
                "                        \"rqstDt\": \"sysdate\",\n" +
                "                        \"firstName\": \"" + setCustRequest.getFirstName() + "\",\n" +
                "                        \"lastName\": \"" + setCustRequest.getLastName() + "\",\n" +
                "                        \"address\": \"" + setCustRequest.getAddr1Txt() + "\",\n" +
                "                        \"city\": \"" + setCustRequest.getCityName() + "\",\n" +
                "                        \"state\": \"" + setCustRequest.getStCd() + "\",\n" +
                "                        \"zip\": \"" + setCustRequest.getZipCd() + "\"\n" +
                "                    }\n" +
                "                }\n" +
                "            ]\n" +
                "        }\n" +
    ...
    private String getServiceBody_CCPA_Data(SetCustRequest setCustRequest) {
        String json_body = "{\n" +
                "    \"tables\": [\n" +
                "        {\n" +
                "            \"name\": \"XTRA_PRIVACY_REQUEST\",\n" +
                "            \"rows\": [\n" +
                "                {\n" +
                "                    \"action\": \"INSERT\",\n" +
                "                    \"colData\": {\n" +
                "                        \"encodedXtraCardNbr\": \"" + setCustRequest.getEncodedXtraCardNbr() + "\",\n" +
                "                        \"rqstDt\": \"" + setCustRequest.getRqstDt() + "\",\n" +
                "                        \"rqstStateCd\": \"" + setCustRequest.getRqstStateCd() + "\",\n" +
                "                        \"purgeRqstInd\": \"" + setCustRequest.getPurgeRqstInd() + "\",\n" +
                "                        \"rptRqstInd\": \"" + setCustRequest.getRptRqstInd() + "\",\n" +
                "                        \"rptDestEmailAddrTxt\": \"" + setCustRequest.getEmailAddrTxt() + "\",\n" +
                "                        \"firstUpdtSrcCd\": \"001\",\n" +
                "                        \"firstUpdtById\": \"CP419342347956\",\n" +
                "                        \"firstUpdtDt\": \"SYSDATE\",\n" +
                "                        \"lastUpdtSrcCd\": \"001\",\n" +
                "                        \"lastUpdtById\": \"CP419342347956\",\n" +
                "                        \"lastUpdtDt\": \"SYSDATE\"\n" +
                "                    }\n" +
                "                }\n" +
                "            ]\n" +
    ...
    private String getServiceBody_CCPA_Data_Exclude_Optional(SetCustRequest setCustRequest) {
        String json_body = "{\n" +
                "    \"tables\": [\n" +
                "        {\n" +
                "            \"name\": \"XTRA_PRIVACY_REQUEST\",\n" +
