...
@Data
@Slf4j
public class GetCustTablesnPreferencesService_old {
    ...
    public void viewGetCustTablesnPreferences(GetCustRequest getCustRequest) throws ParseException {
        ...
        if (ver.equals(expver)) {
            ...
            requestSpecBuilder.setBaseUri(serviceConfig.getGetcustUrl())
                    .setBasePath("api/v1.2/customers/{search_card_type},{search_card_nbr}")
                    .addPathParam("search_card_type", getCustRequest.getSearchCardType())
                    .addPathParam("search_card_nbr", getCustRequest.getSearchCardNbr())
                    .addQueryParam("msg_src_cd", msgSrcCd)
                    .addQueryParam("user_id", userId)
...
*/
    ...
    /**
     * Delete Test Data for getCust Tables and Preferences Scenario
     */
    public void deleteGetCustTablesnPreferencesTestData() {
	  /*
	    Purge All Test Cards
	  */
        List<Integer> xtraCardNbrList = Arrays.asList(900058421, 900058422, 900058423, 900058424, 900058425, 900058426, 900058427, 900058428, 900058429, 900058430, 900058431, 900058432, 900058433, 900058434, 900058435, 900058436, 900058437, 900058438, 900058439, 900058440, 900058441, 900058442);
        List<Integer> custIdList = Arrays.asList(80154, 80155, 80156, 80157, 80158, 80159, 80160, 80161, 80162, 80163, 80164, 80165, 80166, 80167, 80168, 80169, 80170, 80171, 80172, 80173, 80174, 80175, 80176);
        List<Integer> ephLinkIdList = Arrays.asList(90019811);
        List<Integer> cmpgnIdList = Arrays.asList(59726, 64355, 42239, 39133);
