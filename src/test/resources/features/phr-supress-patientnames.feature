...
Feature: View Customer Phr Rewards
  ...
  Scenario: View Customer Pharmacy Health Rewards Details in DashBoard
    ...
    And I see my PHR Campaign End Date as "2021-12-31"
    ...
    And I see under my PHR who all enrolled as
      | capped | maxCredits | maxRewardAmount |
      | false  | 100.0      | 50.0            |
      | false  | 100.0      | 50.0            |
...
#    |Mary      |
  ...
  Scenario: View Customer Pharmacy Health Rewards Details in DashBoard
    ...
    And I see under my PHR who all enrolled true as
      | capped | maxCredits | maxRewardAmount | cappedDate |
      | true   | 100.0      | 50.0            | 0          |
      | true   | 100.0      | 50.0            | 0          |
  ...
  Scenario Outline: View Customer Pharmacy Health Rewards Details in DashBoard
    ...
    Examples:
      ...
      | "I am a non-targeted customer who filled 150 prescriptions" | 98158288      | 59726       | "$5 Pharmacy and Health ExtraBucks Rewards" | "2021-12-31"      | "Q"                 | 10.0            | 5.0           | 10.0                     | "false"             | 0.0             | 75.0               | 150.0               | "WEB"   |
  ...
  Scenario Outline: View Customer Pharmacy Health Rewards Details in DashBoard
    ...
    Examples:
      ...
      | "I have never enrolled into PHR" | 98158289      | 44496       | "2021 - PHR Regular" | "2021-12-31"      | "Q"                 | 10.0            | 5.0           | 10.0                     | "false"             | 0.0             | 0.0                | 0.0                 | "WEB"   | "false"  |
  ...
  Scenario Outline: View Customer Pharmacy Health Rewards Details in DashBoard
    ...
    Examples:
      | scenario                     | xtra_card_nbr | campaign_id | web_description                             | campaign_end_date | threshold_type_code | first_threshold | reward_amount | points_to_next_threshold | offer_limit_reached | points_progress | year_todate_earned | year_todate_credits | channel | enrolled |
      | "I have unenrolled from PHR" | 98158290      | 59726       | "$5 Pharmacy and Health ExtraBucks Rewards" | "2021-12-31"      | "Q"                 | 10.0            | 5.0           | 10.0                     | "false"             | 0.0             | 0.0                | 0.0                 | "WEB"   | "false"  |
#  | "I have enrolled in PHR but my HIPPA expired"                               |      98158291 |       59726 | "$5 Pharmacy and Health ExtraBucks Rewards" | "2020-12-31"              | "Q"                 |              10.0 |             5.0 |                    10.0    | "false"               |               0.0  |    "WEB"   | "false"  |
  ...
  Scenario Outline: View Customer Pharmacy Health Rewards Details in DashBoard
    ...
    Examples:
      | scenario                                              | xtra_card_nbr | campaign_id | web_description                             | campaign_end_date | threshold_type_code | first_threshold | reward_amount | points_to_next_threshold | offer_limit_reached | points_progress | year_todate_earned | year_todate_credits | channel | enrolled |
      | "I recently enrolled in PHR as non-targeted customer" | 98158284      | 59726       | "$5 Pharmacy and Health ExtraBucks Rewards" | "2021-12-31"      | "Q"                 | 10.0            | 5.0           | 10.0                     | "false"             | 0.0             | 0.0                | 0.0                 | "WEB"   | "true"   |
      | "I recently enrolled in PHR as targeted customer"     | 98158285      | 64355       | "$2 Pharmacy and Health ExtraBucks Rewards" | "2021-12-31"      | "Q"                 | 4.0             | 2.0           | 4.0                      | "false"             | 0.0             | 0.0                | 0.0                 | "WEB"   | "true"   |
      | "I am a targeted customer who joined PHR in 2015"     | 98158286      | 64355       | "$2 Pharmacy and Health ExtraBucks Rewards" | "2021-12-31"      | "Q"                 | 4.0             | 2.0           | 1.0                      | "false"             | 3.0             | 0.0                | 3.0                 | "WEB"   | "true"   |
      | "I am a non-targeted customer who joined PHR in 2015" | 98158287      | 59726       | "$5 Pharmacy and Health ExtraBucks Rewards" | "2021-12-31"      | "Q"                 | 10.0            | 5.0           | 8.0                      | "false"             | 2.0             | 0.0                | 2.0                 | "WEB"   | "true"   |